...
<div id="main-section" class="sm:ml-64">
    ...
    <div id="policyPage" class="bg-gray-100 text-gray-900 mt-14">
        ...
        <main class="container mx-auto px-6 lg:px-20 py-10 ">
            ...
            <section class="space-y-8">
                ...
                <p class="text-lg text-gray-800 leading-relaxed prose text-justify">
            ...
            <section class="space-y-8 mt-10">
                ...
                <div class="space-y-4">
                    <p class="text-lg text-gray-700 prose text-justify">
                        To participate in the voting process, ensure that you meet the following requirements:
                    </p>
                    <ul class="list-disc pl-6 text-gray-700 space-y-2 prose text-justify">
            ...
            <section class="space-y-8 mt-10">
                ...
                <div class="space-y-4">
                    ...
                    <ol class="list-decimal pl-6 text-gray-700 space-y-2 prose text-justify">
            ...
            <section class="space-y-8 mt-10 bg-yellow-100 border-l-4 border-yellow-500 p-6 rounded-lg">
                ...
                <p class="text-lg text-gray-800 prose text-justify">
